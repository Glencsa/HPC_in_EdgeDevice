...
![GPTQ](image/image5.jpg)

那GPTQ有什么优势呢？


![GPTQ](image/image6.jpg)
...
### 5. TP、DP、PP通信量大小对比和分析
一般来说 TP>DP>PP,一般我们在同一台机器的GPU间做张量模型并行。在不同的机器上做数据并行。
